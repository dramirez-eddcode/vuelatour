                        ...
                        <div className="aspect-square sm:aspect-[4/3] relative">
                          {dest.image_url ? (
                            ...
                            <div className="w-full h-full bg-navy-100 dark:bg-navy-800 flex items-center justify-center">
                              <PaperAirplaneIcon className="w-8 h-8 text-navy-300 dark:text-navy-600" />
                            </div>
                          )}
                        </div>
                      </div>
                    ...
                    <div className="flex">
                        ...
                        <div className="aspect-square sm:aspect-[4/3] relative">
                          {tour.image_url ? (
                            ...
                            <div className="w-full h-full bg-brand-100 dark:bg-brand-900/50 flex items-center justify-center">
                              <GlobeAmericasIcon className="w-8 h-8 text-brand-300 dark:text-brand-700" />
                            </div>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="flex-1 p-3 sm:p-4 flex flex-col justify-center min-w-0">
                        ...
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <div className="text-right flex-shrink-0">
                            <div className="font-bold text-sm sm:text-base text-brand-600 dark:text-brand-400">
